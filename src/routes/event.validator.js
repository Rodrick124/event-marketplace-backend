...
exports.updateEventValidationRules = [
	...
	body('location').optional().isObject().withMessage('Location must be an object'), // if location is present, it must be an object
	body('location.address').if(body('location').exists()).notEmpty().isString().withMessage('Location address is required when location is provided'),
	body('location.city').if(body('location').exists()).notEmpty().isString().withMessage('Location city is required when location is provided'),
	body('location.country').if(body('location').exists()).notEmpty().isString().withMessage('Location country is required when location is provided'),
